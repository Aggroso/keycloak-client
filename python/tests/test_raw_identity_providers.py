...
from keycloak_client.raw.identity_providers import IdentityProviderRoutes, ROUTE_SPECS
...
def test_identity_providers_routes_call_transport() -> None:
    async def run() -> None:
        transport = FakeTransport()
        routes = IdentityProviderRoutes(transport)
